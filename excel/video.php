		...
		<div class="container-fluid">
			<div class="row" style="margin-top:18px;">
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="padding-left: 0;padding-right: 40px;">
					...
					<div id="scrollup" class="table-responsive" style="max-height: 100%;">
						<?php
							$SQLSELECT = "SELECT * FROM video ORDER BY RAND() LIMIT 1";
							$result_video =  mysqli_query($conn,$SQLSELECT);
							$row = mysqli_fetch_array($result_video,MYSQLI_ASSOC);
						?>
						...
						<video id="video" class="video_home" autoplay="autoplay" onloadstart="playVideo();">
						  <source type="video/ogg; codecs=theora,vorbis" src="<?php echo $row['url_video']?>">
						</video>
					</div>
				</div>
