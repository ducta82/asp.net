...
<div><a href="#"><img src="banner-sale.jpg" width="150" height="auto"></a></div>
  <br><a href="/san-go-gia-re"><div><img src="san-go-gia-re.jpg" width="150" height="auto"></div></a>    
</div>
  
<div id="divAdLeft" style="display: block; position: absolute; top: 10px; left: 196.5px;">    
<div><a href="/san-go-wineo"><img src="san-go-duc-wineo.jpg" width="150" height="auto"></a></div>
  <br><a href="/san-go-malaysia"><div><img src="san-go-malaysia.jpg" width="150" height="auto"></div></a>    
</div>
<script>    
...
<script>    
document.write("<script type='text/javascript' language='javascript'>MainContentW = 1200;LeftBannerW = 150;RightBannerW = 125;LeftAdjust = 5;RightAdjust = 5;TopAdjust = 10;ShowAdDiv();window.onresize=ShowAdDiv;;<\/script>");   
</script>
<?php wp_footer(); ?>
</body>
</html>
